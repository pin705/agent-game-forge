...
- 🖼️ **أحضِر مولّد الصور الخاص بك** — قدّم مفتاح API لمزوّد الصور المفضّل لديك، أو استخدم مولّد الصور المدمج في Codex CLI (GPT-Image2). تبقى المفاتيح على جهازك.
